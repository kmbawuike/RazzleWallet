			...
			<div>
				...
				<div className="first">
					<div className="slide">
						...
						<div className="slidem"><img className="slide2" src={image2} alt=""/></div>
					</div>
					<img className="image1" src={image1} alt=""/>
					<div className="text1">
					<h2 className="head">Transparent and cheaper fees.</h2>
						<p className="words">We know how hard you work for your money.We workhard too and
							we respect that.We are clear about our fees and works to offer the cheapest rates possible.
						</p>
				...
				<div className="slide">
					...
					<div className="text2">
						...
						<p className="words">Paying your Netflix subscription,shopping on Amazon or checking out at Shoprite,tour Wallets virtual doller card and physical debit card work everywhere.</p>
						<button className="btn1">Create Your Account</button>
					</div>
				</div>
				<div className="third">
					<div className="image-6"><img className="image6"src={image6} alt=""/></div>
					<div className="last"></div>
					<img className="image3"src={image1} alt=""/>
					<div className="text3">
					<h2 className="head">GO International.</h2>
						<p className="words">Wallets allows you easily send money to mobile money accounts in Ghana and Kenya. it's faster, cheaper amd more secure than anything out ther.More countries coming soon.</p>
						<button className="btn1">Create Your Account</button>
					</div>
				</div>
			</div>
